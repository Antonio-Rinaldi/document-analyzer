"""Detailed module documentation for `src/document_analyzer_api/infrastructure/modalities/ollama_image_provider.py`.

File role:
- Located in the infrastructure adapter layer.
- Defines logic and symbols for `ollama_image_provider.py` within Document Analyzer V1.
...
class OllamaImageProvider(ImageProviderPort):
    """Detailed class documentation for `OllamaImageProvider`.
    
    This provider adapter belongs to `src/document_analyzer_api/infrastructure/modalities/ollama_image_provider.py` and encapsulates one cohesive responsibility in the
    ...
    def __init__(self, *, base_url: str, model: str, fallback: ImageProviderPort | None = None) -> None:
        ...
        This callable is implemented in `src/document_analyzer_api/infrastructure/modalities/ollama_image_provider.py` and contributes to the module workflow
        through deterministic input/output behavior and explicit collaboration contracts.
            ...
            Args:
                ...
                fallback: Input parameter for `__init__`.
