"""Module `src/document_analyzer_api/domain/ports/text_generation_client.py`.
...
class TextGenerationClientPort(Protocol):
    """TextGenerationClientPort component.
    
    This class is defined in `src/document_analyzer_api/domain/ports/text_generation_client.py` and encapsulates a single cohesive concern.
    ...
    async def generate_answer(self, question: str, context_chunks: list[str]) -> str:
        ...
        This callable is implemented in `src/document_analyzer_api/domain/ports/text_generation_client.py` and contributes to module-level behavior
